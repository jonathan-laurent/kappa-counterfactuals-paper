...
Because of their dynamic and combinatorial nature, rule-based models
...
\ItAction{} alter the behavior of $T$ with intervention $\iota$ and
...
\begin{definition}[Semantics of counterfactual statements]
  ...
  \[ \PCFST{} \eqdef \ \ProbParen{\psi[\ATRAJ{}(\Sigma)] \,\, | \,\,
      T(\Sigma) = \tau}. \]
\end{definition}
...
$T_\iota(\Sigma) \,|\, \{ T(\Sigma) \!=\! \tau \}$).  Such instances
