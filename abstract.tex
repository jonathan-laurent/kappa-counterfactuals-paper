...
\begin{abstract}
  ...
  in biology. We propose and implement a method for executing
  computational experiments that provide a rigorous semantics to
  counterfactual statements. Our method is close in spirit to the
  ideas developed by Pearl and Halpern, but addresses models whose
  mechanistic complexity is not readily translatable into structural
  equations. By leveraging a stochastic simulator we sample
