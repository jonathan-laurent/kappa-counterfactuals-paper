...
\tryinline{\EMBS{r}{m} \eqdef \{ \xi \,:\, \TRIGGERABLE{m}{(r, \xi)}\}.}
...
\cite{DanosEtAl-APLAS07,BoutillierEK17}\longversion{; it is available at
kappalanguage.org}. The algorithm outputs a sequence of
...
For example, a simulation might produce the following trace
